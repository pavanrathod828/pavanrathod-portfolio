            ...
            <AnimatePresence>
              ...
              {open ? (
                <motion.div
                  ...
                  className="fixed inset-y-0 right-0 z-[70] flex h-full w-[min(360px,100%)] flex-col border-l border-[#d9cfb5] bg-[#faf7f0] px-6 py-6 shadow-[0_20px_60px_-15px_rgba(28,26,23,0.25)]"
                >
